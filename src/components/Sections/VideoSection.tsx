    ...
    <Wrapper>
      <section className="mt-10" id="action">
        <div className="flex flex-col items-center justify-between space-y-4 md:flex-row md:items-center md:space-y-0">
          <h3 className="mx-3 min-w-80 text-center text-3xl font-bold text-sunflower-800 md:text-left md:text-4xl dark:text-sunflower-100">
            Zobacz naszą aplikację w akcji!
          </h3>
          <p className="mx-3 text-center font-semibold text-sunflower-600 md:text-left xl:max-w-4xl dark:text-sunflower-300	">
